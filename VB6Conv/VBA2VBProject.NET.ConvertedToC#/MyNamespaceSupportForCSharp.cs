...
namespace VBA2VBProject.My
{
	sealed partial class MyProject
	{
		...
		{
			global::VBA2VBProject.frmVfcMain frmVfcMain_instance;
			bool frmVfcMain_isCreating;
			public global::VBA2VBProject.frmVfcMain frmVfcMain {
				[DebuggerStepThrough] get { return GetForm(ref frmVfcMain_instance, ref frmVfcMain_isCreating); }
				[DebuggerStepThrough] set { SetForm(ref frmVfcMain_instance, value); }
			}
